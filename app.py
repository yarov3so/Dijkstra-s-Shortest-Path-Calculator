...
def make_graph():
    st.markdown("### Step 1: Enter your graph nodes")
    nodes_str = st.text_input("Please enter all the nodes in the graph separated by commas:", key="nodes")
    graph = {}
...
def dijkstra(graph, start_node):
    ...
    st.markdown("## DIJKSTRA'S ALGORITHM LEARNING TOOL by yarov3so")
...
# Streamlit UI logic
st.title("Dijkstra's Algorithm Streamlit Tool")

graph_button = st.button("Define Graph")

if graph_button or "graph" in st.session_state:

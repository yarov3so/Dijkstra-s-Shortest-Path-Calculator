...
def make_graph():
    ...
    if nodes_str:
        ...
        undirected_yn = st.text_input("Make the graph undirected? *This process automatically adds missing entries to ensure reciprocity, and reduces the number of edges between any pair of nodes to 1, assigning that edge the lowest weight among all the edges that originally linked that pair.* (yes/no):", key="undirected")

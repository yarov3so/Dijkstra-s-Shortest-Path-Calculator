...
def make_graph():
    ...
    if nodes_str:
        ...
        st.markdown(f"*This process automatically adds missing entries to ensure reciprocity, and reduces the number of edges between any pair of nodes to 1, assigning that edge the lowest weight among all the edges that originally linked that pair. As such, it can be handy for fixing typos and omissions when dealing with undirected graphs.*")
